             ...
             (l.VERSION = "1.12.4"),
                      ...
                      (l.prototype = {
                                                          ...
                                                          if ((g++, !f.hasClass("bs-title-option"))) {
                                                                   ...
                                                                   if ((f.data("content") || (o = r + '<span class="text">' + o + q + "</span>"), t && !0 !== f.data("divider"))) {
                                                                            ...
                                                                            if (0 === f.index()) {
                                                                                     ...
                                                                                     (y =
                                                                                              (s.data("icon") ? '<span class="' + c.options.iconBase + " " + s.data("icon") + '"></span> ' : "") +
                                                                                              '<span class="text">' +
                                                                                              j(y) +
                                                                                              z +
                                                                                              "</span>"),
                                                                            ...
                                                                            (k = f.data("prevHiddenIndex")), f.next().data("prevHiddenIndex", void 0 !== k ? k : b), d.push(h(i(o, m, n, p), b, "hidden is-hidden"));
                                                                   else {
                               ...
                               render: function (b) {
                                        ...
                                        if (this.multiple && this.options.selectedTextFormat.indexOf("count") > -1) {
                                                 ...
                                                 if ((h.length > 1 && f.length > h[1]) || (1 == h.length && f.length >= 2)) {
                                                          ...
                                                          g = ("function" == typeof this.options.countSelectedText ? this.options.countSelectedText(f.length, i) : this.options.countSelectedText)
                               ...
                               keydown: function (b) {
                                        ...
                                        if (
                                                 (i.options.liveSearch && /(^9$|27)/.test(b.keyCode.toString(10)) && f && (b.preventDefault(), b.stopPropagation(), i.$menuInner.click(), i.$button.focus()),
                                                 ...
                                                 (d = i.options.liveSearch ? c.index(c.filter(".active")) : c.index(c.find("a").filter(":focus").parent())),
                                                          ...
                                                          38 == b.keyCode
                                                                   ? ((!i.options.liveSearch && d != e) || -1 == d || d--, d < 0 && (d += c.length))
                                                                   : 40 == b.keyCode && ((i.options.liveSearch || d == e) && d++, (d %= c.length)),
                                                          i.$menuInner.data("prevIndex", d),
                                                          i.options.liveSearch
                                                                   ? (b.preventDefault(), g.hasClass("dropdown-toggle") || (c.removeClass("active").eq(d).addClass("active").children("a").focus(), g.focus()))
                               ...
                               return (
                                        this.each(function () {
                                                 ...
                                                 function e(a, b, c) {
                                                          ...
                                                          if (
                                                                   (b &&
                                                                            ((e = parseInt(z.css("top")) + ((a * parseInt(d.wheelStep)) / 100) * z.outerHeight()),
                                                                            (e = Math.min(Math.max(e, 0), f)),
                                                                            (e = a > 0 ? Math.ceil(e) : Math.floor(e)),
                                                                            z.css({ top: e + "px" })),
                                                                   (o = parseInt(z.css("top")) / (u.outerHeight() - z.outerHeight())),
                                                 ...
                                                 function f() {
                                                          (n = Math.max((u.outerHeight() / u[0].scrollHeight) * u.outerHeight(), r)), z.css({ height: n + "px" });
                                                 ...
                                                 if (u.parent().hasClass(d.wrapperClass)) {
                                                          ...
                                                          var x = a(q).addClass(d.wrapperClass).css({ position: "relative", overflow: "hidden", width: d.width, height: d.height });
                                                          ...
                                                          var y = a(q)
                                                                   ...
                                                                   A = "right" == d.position ? { right: d.distance } : { left: d.distance };
                                                          y.css(A),
                                                                   z.css(A),
                                                                   u.wrap(x),
                                                                   u.parent().append(z),
                                                                   ...
                                                                   f(),
                                                                   "bottom" === d.start
                                                                            ? (z.css({ top: u.outerHeight() - z.outerHeight() }), e(0, !0))
                                                                            : "top" !== d.start && (e(a(d.start).position().top, null, !0), d.alwaysVisible || z.hide()),
                                                                   (function (a) {
    ...
    (function (a, b) {
             ...
             function f(a) {
                      var c,
                               ...
                               e = { top: 0, left: 0 },
                               f = a && a.ownerDocument;
                      return (c = f.documentElement), void 0 !== a.getBoundingClientRect && (e = a.getBoundingClientRect()), (d = b(f)), { top: e.top + d.pageYOffset - c.clientTop, left: e.left + d.pageXOffset - c.clientLeft };
             }
             function g(a) {
                      var b = "";
             ...
             return (
                      ...
                      (k.ripple = function (a, b) {
                               ...
                               if (((b = b || {}), (b.wait = b.wait || 0), (b.position = b.position || null), c))
                                        for (var d, g, h, i = {}, j = 0, k = { type: "mousedown", button: 1 }; j < c; j++)
                                                 if (
                                                          ((d = a[j]),
                      ...
                      (k.calm = function (a) {
                               a = e(a);
                               for (var b = { type: "mouseup", button: 1 }, c = 0, d = a.length; c < d; c++) o.hide(b, a[c]);
                      }),
