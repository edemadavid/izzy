...
<?php require('./headers/navbar.php') ?>
    ...
    <div class="swiper-container">
      <div class="swiper-wrapper">
        <section
          class="swiper-slide background-splash-2 section-overlay text-left"
        >
          <div class="container">
            <div class="full-height vertical-middle">
              <div class="col-md-12">
                <h1
                  class="black hyper text-white os-animation"
                ...
                <object
                  ...
                  width="15"
                  height="15"
                  data="assets/images/svg/shape-triangle.svg"
                >
                ...
                <object
                  ...
                  width="15"
                  height="15"
                  data="assets/images/svg/shape-circle-lined.svg"
                >
                  <img src="assets/images/svg/fallback-image.png" alt="…" />
                </object>
                <object
                  ...
                  width="15"
                  height="15"
                  data="assets/images/svg/shape-triangle-rotated.svg"
                >
                  <img src="assets/images/svg/fallback-image.png" alt="…" />
                </object>
              </div>
        ...
        <section
          class="swiper-slide background-splash section-overlay text-left"
        >
          <div class="container">
            <div class="full-height vertical-middle">
              <div class="col-md-12">
    ...
    <section class="section section-dark text-left">
      <div class="container">
        ...
        <div
          class="col-md-12 event-wrap margin-bottom os-animation"
          data-os-animation="fadeInUp"
          data-os-animation-delay="0s"
        >
          ...
          <div class="col-md-12 event-icons text-left vertical-middle">
            ...
            <h3>
              SYDNEY, AUSTRALIA
              <small
                ><span class="text-primary">@&nbsp;</span>Rio Costa Palace
                Club</small
              >
            </h3>
          </div>
        ...
        >
          ...
          <div class="col-md-12 event-icons text-left vertical-middle">
            ...
            <h3>
              TORONTO, CANADA
              <small
                ><span class="text-primary">@&nbsp;</span>Toronto bay /
                TORClub</small
              >
            </h3>
          </div>
        ...
        >
          ...
          <div class="col-md-12 event-icons text-left vertical-middle">
            ...
            <h3>
              NEW YORK, USA
              <small
                ><span class="text-primary">@&nbsp;</span>TRAP Lobby NYC</small
              >
            </h3>
          </div>
          <div class="col-md-12 event-info">
    ...
    <section
      class="section section-overlay banner-content background-model-3 text-center"
    >
